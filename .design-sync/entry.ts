// Barrel entry for the claude.ai/design import (see .design-sync/NOTES.md).
// Re-exports only the design-system surface — no routes, no server code.
...
export * from '../src/components/compliance-mark';
export * from '../src/components/motion';
export * from '../src/components/site-chrome';

// Providers the previews wrap with.
export { I18nProvider } from '../src/i18n/i18n';
