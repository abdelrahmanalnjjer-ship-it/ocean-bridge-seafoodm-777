...
const en: Dict = {
  ...
  "section.vlog": "Field Journal",
  "section.vlog.sub": "Notes from origin ports, facility audits, and cold-chain operations.",
...
const ar: Dict = {
  ...
  "section.vlog": "يوميات الميدان",
  "section.vlog.sub": "ملاحظات من موانئ المصدر وتدقيق المنشآت وسلسلة التبريد.",
...
const zh: Dict = {
  ...
  "section.vlog": "现场日志",
  "section.vlog.sub": "来自原产港口、工厂审核与冷链作业的记录。",
